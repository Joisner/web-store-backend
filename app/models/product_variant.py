# Elimina todo el contenido de este archivo o comenta la clase ProductVariant
# Deja el archivo vacío o bórralo si no es necesario.
from app.db.base_class import Base

# Elimina o comenta toda la clase ProductVariant aquí
